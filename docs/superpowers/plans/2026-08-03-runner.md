...
- **Pozor na zástupné vzory nette/testeru:** `%a%` matchuje cokoliv **kromě odřádkování**, `%A%` včetně něj. U víceřádkové hlášky patří `%A%` — a nikdy neohýbej hlášku proto, aby vyhověla vzoru.
